#ifndef __QUADTREEKOKA_H__
#define __QUADTREEKOKA_H__
...
template<typename TYPE>
inline void QuadTreeKoka::CollectIntersections(std::vector<GameObject*>& gameObject, const TYPE& primitive) const {
	if (root != nullptr) {
