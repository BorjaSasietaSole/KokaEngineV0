...
void QuadTreeKoka::InitQuadTree(const math::AABB& aabb, bool clearAllGameObjects) {
...
void QuadTreeKoka::ExpandLimits(GameObject* gameObject) {
...
void QuadTreeKoka::Remove(GameObject* gameObject) {
	if (root != nullptr) {
